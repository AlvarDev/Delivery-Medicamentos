...
public class PresentacionxMedicamentoBean {
	int codMedicamento;
	...
	public int getCodMedMarca() {
		return codMedMarca;
	}
	public void setCodMedMarca(int codMedMarca) {
		this.codMedMarca = codMedMarca;
	}
	public int getCodPresMarca() {
		return codPresMarca;
	}
	public void setCodPresMarca(int codPresMarca) {
		this.codPresMarca = codPresMarca;
	}
}
